...
public class AvariciousPrayer extends AbstractPrayer {
    public static final String Prayer_ID = VUPShionMod.makeID(AvariciousPrayer.class.getSimpleName());
    ...
    public AvariciousPrayer(int turns, int amount) {
        this.ID = Prayer_ID;
        this.name = NAME;
        this.turns = turns;
        this.amount = amount;
...
//        this.region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage(VUPShionMod.assetPath("img/prayer/BloodPrayerPrayer36.png")), 0, 0, 36, 36);
    ...
    public AbstractPrayer makeCopy() {
        return new AvariciousPrayer(this.turns, this.amount);
    }
}
