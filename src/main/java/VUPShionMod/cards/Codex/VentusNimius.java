...
public class VentusNimius extends AbstractCodexCard {
    public static final String ID = VUPShionMod.makeID(VentusNimius.class.getSimpleName());
    ...
    public VentusNimius(int upgrades) {
        ...
        this.parentCardID = VentusRapidus.ID;
    }
