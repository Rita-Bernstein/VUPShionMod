...
public class ChainPursuit extends AbstractShionCard {
    public static final String ID = VUPShionMod.makeID(ChainPursuit.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p,p,new ChainPursuitPower(p)));
    }
