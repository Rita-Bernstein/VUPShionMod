...
import VUPShionMod.powers.Shion.CollaborativeInvestigationPower;
import VUPShionMod.powers.Shion.StrikeIntegratedPower;
import com.megacrit.cardcrawl.actions.common.ApplyPowerAction;
import com.megacrit.cardcrawl.characters.AbstractPlayer;
import com.megacrit.cardcrawl.monsters.AbstractMonster;

public class CollaborativeInvestigation extends AbstractShionCard {
    public static final String ID = VUPShionMod.makeID(CollaborativeInvestigation.class.getSimpleName());
    ...
    public CollaborativeInvestigation() {
