...
public class TrainingPropeller extends AbstractShionRelic {
    public static final String ID = VUPShionMod.makeID(TrainingPropeller.class.getSimpleName());
    public static final String IMG_PATH = "img/relics/TrainingPropeller.png";
    private static final String OUTLINE_PATH = "img/relics/outline/TrainingPropeller.png";
    private static final Texture IMG = new Texture(VUPShionMod.assetPath(IMG_PATH));
    private static final Texture OUTLINE_IMG = new Texture(VUPShionMod.assetPath(OUTLINE_PATH));

    private boolean isEliteOrBoss = false;

    public TrainingPropeller() {
    ...
    public void atPreBattle() {
        ...
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player,
                new DexterityPower(AbstractDungeon.player, this.counter - 4)));
