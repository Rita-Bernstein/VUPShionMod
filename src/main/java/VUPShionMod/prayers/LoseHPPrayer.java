...
public class LoseHPPrayer extends AbstractPrayer {
    public static final String Prayer_ID = VUPShionMod.makeID(LoseHPPrayer.class.getSimpleName());
    ...
    public LoseHPPrayer(int turns, int amount) {
        this.ID = Prayer_ID;
        this.name = NAME;
        this.turns = turns;
        this.amount = amount;
...
//        this.region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage(VUPShionMod.assetPath("img/prayer/BloodPrayerPrayer36.png")), 0, 0, 36, 36);
    ...
    public AbstractPrayer makeCopy() {
        return new LoseHPPrayer(this.turns, this.amount);
    }
}
