...
public class Bento extends AbstractShionImagePotion {
    public static final String POTION_ID = VUPShionMod.makeID(Bento.class.getSimpleName());
    ...
    public Bento() {
        super(POTION_ID, Bento.class.getSimpleName() + ".png", RARITY);
        this.isThrown = false;
...
//        this.labOutlineColor = VUPShionMod.Shion_Color;
    ...
    public void initializeData() {
        ...
        this.description = String.format(this.potency > 1 ? DESCRIPTIONS[1] : DESCRIPTIONS[0], this.potency * 9, this.potency);
        this.tips.clear();
    ...
    public void use(AbstractCreature target) {
        if ((AbstractDungeon.getCurrRoom()).phase == AbstractRoom.RoomPhase.COMBAT) {
            addToBot(new HealAction(AbstractDungeon.player, AbstractDungeon.player, this.potency * 9));
        } else {
            AbstractDungeon.player.heal(this.potency * 9);
        }
