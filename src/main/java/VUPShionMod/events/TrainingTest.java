...
public class TrainingTest extends AbstractImageEvent {
    public static final String ID = VUPShionMod.makeID(TrainingTest.class.getSimpleName());
    ...
    public TrainingTest() {
        super(NAME, DESCRIPTIONS[0], VUPShionMod.assetPath("img/events/BossEvent4.png"));
    ...
    protected void buttonEffect(int buttonPressed) {
        switch (this.curScreen) {
            case INTRO:
                ...
                this.imageEventText.setDialogOption(OPTIONS[1], new Warlike());
    ...
    private void fightBoss() {
        ...
        AbstractDungeon.getCurrRoom().spawnRelicAndObtain(Settings.WIDTH * 0.5f, Settings.HEIGHT * 0.5f, new Warlike());
