...
public class HomoRapidus extends AbstractCodexCard {
    public static final String ID = VUPShionMod.makeID(HomoRapidus.class.getSimpleName());
    ...
    public HomoRapidus(int upgrades) {
