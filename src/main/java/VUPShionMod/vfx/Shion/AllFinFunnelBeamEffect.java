...
public class AllFinFunnelBeamEffect extends AbstractGameEffect {
    ...
    public AllFinFunnelBeamEffect(ArrayList<AbstractFinFunnel> finFunnels, boolean isFlipped) {
        super();
    ...
    public AllFinFunnelBeamEffect(ArrayList<AbstractFinFunnel> finFunnels) {
