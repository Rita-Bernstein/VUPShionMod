...
import VUPShionMod.vfx.Shion.FinFunnelMinionBeamEffect;
...
public class BossFinFunnelMinionEffect extends AbstractGameEffect {
    ...
    public BossFinFunnelMinionEffect(AbstractShionBoss boss, int index, boolean isAoe) {
        this.index = index + 1;
    ...
    public void update() {
        ...
        if (this.fireTimer > 0.0f) {
            ...
            if (this.fireTimer <= 0.0f) {
                ...
                AbstractDungeon.effectsQueue.add(new FinFunnelMinionBeamEffect(this.skeleton, true, this.scale));
